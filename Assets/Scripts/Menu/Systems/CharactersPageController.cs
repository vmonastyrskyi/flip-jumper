...
namespace Menu.Systems
{
    public class CharactersPageController : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            ...
            CharactersPageEventSystem.instance.OnSuccessfulCharacterPurchase += SetSelectPanelActive;
        ...
        private void AttachCharacters()
        {
            ...
            for (var i = 0; i < _userData.Characters.Length; i++)
            {
                ...
                if (character.IsSelected)
                {
                    ...
                    characterItem.CharacterPrefab.GetComponent<Rotate>().enabled = true;
        ...
        private void ChangeCharacter()
        {
            ...
            var character = characterItem.Character;
            ...
            foreach (var panel in characterPanels)
            {
                ...
                item.CharacterPrefab.transform.rotation = Quaternion.Euler(0, -90, -30);
                item.CharacterPrefab.GetComponent<Rotate>().enabled = false;
            }

            characterItem.CharacterPrefab.GetComponent<Rotate>().enabled = true;
        }

        private void ValidatePurchase(Character character)
        {
            switch (character.Currency)
            {
                case PriceCurrency.Coins:
        ...
        private void PurchaseCharacter(Character character)
        {
            _buyButton.onClick.RemoveAllListeners();
            _selectButton.onClick.RemoveAllListeners();
            ...
            CharactersPageEventSystem.instance.SuccessfulCharacterPurchase();
        }
