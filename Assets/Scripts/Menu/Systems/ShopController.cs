...
namespace Menu.Systems
{
    public class ShopController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            PlatformsPageEventSystem.instance.OnSuccessfulPlatformPurchase += SetCashInformation;
            MapsPageEventSystem.instance.OnSuccessfulMapPurchase += SetCashInformation;
        }
